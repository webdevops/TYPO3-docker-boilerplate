...
case "$1" in
    ...
    ###################################
    "typo3")
        execInDir "$CODE_DIR" "docker run --rm --env COMPOSER_CACHE_DIR=/tmp --user $(id -u):$(id -g) -v $(pwd):/app composer/composer:alpine create-project typo3/cms-base-distribution \"/app/$(basename $CODE_DIR)\""
